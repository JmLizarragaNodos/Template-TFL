    ...
    public class DEF_TFL_Modelo_Datos : Inacap.Common.Dal.Oracle
    {
        ...
        )
        {
            ...
            try
            {
                ...
                param[2] = new OracleParameter("outcur", OracleDbType.RefCursor);
                param[3] = new OracleParameter("p_swt", OracleDbType.Int32);
                param[4] = new OracleParameter("p_msg", OracleDbType.Varchar2, _msg_Size);
                param[5] = new OracleParameter("p_sts", OracleDbType.Varchar2, _sts_Size);
                param[6] = new OracleParameter("p_tbl", OracleDbType.Varchar2, _tbl_Size);
                param[7] = new OracleParameter("p_pkgp", OracleDbType.Varchar2, _pkgp_Size);
                ...
                return new RespuestaSP()
                {
                    swt = int.Parse(param[3].Value.ToString()),
                    msg = param[4].Value.ToString(),
                    sts = param[5].Value.ToString(),
                    tbl = param[6].Value.ToString(),
                    pkgp = param[7].Value.ToString(),
                };
            }
            catch (Exception ex)
            {
        ...
        public RespuestaSP GetDatosDefTFL__INCORRECTO(
            int p_kya,
            out string def_tfl_nombre,
            out string def_tfl_descrip,
            out string def_tfl_version,
