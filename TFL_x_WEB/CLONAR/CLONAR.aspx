<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CLONAR.aspx.cs" Inherits="TFL_x_WEB.CLONAR.CLONAR" %>
  ...
  <div class="page-content">
    ...
    <main id="main" class="container">
      ...
      <section class="row breadcrumb">
        <span class="breadcrumb-item active">Buscar TFL para Clonar</span>
      </section>
      ...
      <section>
        ...
        <div id="resultados" style="display: none;">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-12 col-md-4">
                            <p>
                                <span class="font-weight-bold">Periodo Vigencia Diseño TFL:</span> 
            ...
            <div id="modificarTFL" class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-12 d-flex align-items-end justify-content-between">
                            <h4 class="float-left heading h4-responsive mb-0">Modificar Información</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row mb-4 mt-4">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="md-form">
                                <select name="periodoVigencia_Clonar" class="chosen-select" searchable="Buscar">
                                    <option value="" selected>Seleccione Período</option>
                                    <% foreach(COMBOBOX_ENT x in periodosVigenciaTFL) { %>
                                        <option value="<%= x.codigo %>"><%= x.descripcion %></option>
                                    <% } %>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="md-form">
                                <input type="text" name="nombreTFL" class="form-control mb-0" 
                                placeholder="Ingrese Nombre TFL" maxlength="300" autocomplete="off">
                                <label class="active">Nombre TFL</label>
                            </div>
                        </div>

                        <div class="col-12 col-md-4">
                            <p>
                                <span class="font-weight-bold">Versión TFL:</span> 
                                <span name="periodoVigencia">CAMBIAR</span>
                            </p>
                        </div>
                     ...
                     <div class="row mb-4 mt-4">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="md-form">
                                <input type="text" name="numeroMaximoCualificaciones" 
                                oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                                class="form-control mb-0" 
                                placeholder="Ingrese Número Máximo Cualificaciones" maxlength="300" autocomplete="off">
                                <label class="active">Número Máximo Cualificaciones</label>
                            </div>
                        </div>

                        <div class="col-12 col-md-4">
                            <div class="md-form">
                                <input type="text" name="numeroMaximoUCLs" 
                                oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                                class="form-control mb-0" 
                                placeholder="Ingrese Número Máximo UCLs" maxlength="300" autocomplete="off">
                                <label class="active">Número Máximo UCLs</label>
                            </div>
                        </div>
                     ...
                     <div class="row mb-4 mt-4">
                        ...
                        <div class="col-12 col-md-8">
                            <div class="md-form">
                                ...
                                maxlength="500" class="form-control md-textarea" autocomplete="off"></textarea>

                                <label for="campo_def_04" class="active">Descripción</label>
                            </div>
                        </div>
                ...
                <div class="card-footer">
                    <div class="row my-4">
                        <div class="col d-flex justify-content-end">
                            ...
                            <button type="button" onclick="realizarNuevaBusqueda()" class="btn btn-secondary waves-effect waves-light align-items-center d-flex">
                                Cancelar
                            </button>

                            <button type="button" onclick="abrirModalClonar()" class="btn btn-default waves-effect waves-light align-items-center d-flex">
                                Clonar TFL
                            </button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                <div class="col-12 justify-content-center d-flex flex-wrap">
                    ...
                    class="btn mx-2 btn-default waves-effect waves-light alerta" data-dismiss="modal">Clonar</button>
                </div>
            </div>
        </div>
    </div>
